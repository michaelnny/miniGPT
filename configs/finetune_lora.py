...
class config:
    ...
    max_train_iters: int = 10000  # 10000  # training samples * epochs / batch size, 500000 training samples, with batch size of 120, 4000 iters = one epoch
    ...
    # others
    seed: int = 127
    log_dir: str = './logs_test/finetune_lora'  # save logs and traces
    ckpt_dir: str = './checkpoints_test/finetune_lora'
